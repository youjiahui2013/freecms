...
/**
 * 
 * <p>Title: InfoPreListDirective.java</p>
 * 
 * <p>Description: 上几条 信息列表标签
 * 参数
 * siteid		站点id
 * channelid	栏目id
 ...
 * <p>============================================</p>
 */
public class InfoPreListDirective extends BaseDirective implements TemplateDirectiveModel{
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, 
		...
		if (body!=null) {
			...
			if (loopVars!=null && loopVars.length>0 ) {
				...
				String orderSql="";
				if ("1".equals(hot)) {
					orderSql=" addtime,clickNum";
					if (currInfo!=null) {
						info.setInfoStartClicknum(currInfo.getClicknum());
						info.setInfostarttimeNoeq(currInfo.getAddtime());
					}
				}else {
					if ("1".equals(order)) {
						//固顶有效并降序,发布时间降序(默认)
						orderSql=" addtime,isTop";
						if (currInfo!=null) {
							info.setInfostarttimeNoeq(currInfo.getAddtime());
						}
					}

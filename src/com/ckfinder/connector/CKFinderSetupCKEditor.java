...
/**
 * Source code of <code>&lt;ckfinder:setupCKEditor /&gt;</code> tag.
 */
public class CKFinderSetupCKEditor extends TagSupport {

	private static final String CKFINDER_UPLOAD_URL
			= "/ckfinder/core/connector/java/connector.java?command=QuickUpload&type=";
	...
	private String buildBrowseUrl(final String type) {
		return PathUtils.escape(basePath.concat(CKFINDER_PAGE)
						.concat(type == null ? "" : "?type=".concat(type)));
	}

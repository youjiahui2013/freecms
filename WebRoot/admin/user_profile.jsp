				...
				<TABLE cellSpacing=4 cellPadding=4 width="95%" align=center>
					<TBODY>
						...
						<TR>
							...
							<TD align="left">
		  <input name="user.birthday" id="birthday" class="Wdate"  type="text" size="14" value="${loginAdmin.birthdayStr }"  onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d'})"/>
							</TD>
						</TR>
						<TR>
							<TD width="30%"  align="left">

				...
				<TABLE cellSpacing=4 cellPadding=4 width="99%" align=center>
					<TBODY>
						...
						<TR>
							...
							<TD width="70%" align="left">
							<input type="checkbox" value="1" id="checkboxdemo1" name="checkboxdemo" <s:if test="%{demo.checkboxdemo.indexOf('1')>-1}">checked</s:if>>是
							<input type="checkbox" value="0" id="checkboxdemo0" name="checkboxdemo" <s:if test="%{demo.checkboxdemo.indexOf('1')>-1}">checked</s:if>>否
								<SPAN  id=ctl03>*</SPAN>
							</TD>
						</TR>
						<TR>
						...
						<TR>
							...
							<TD width="70%" align="left">
								<textarea onblur="this.className='colorblur';" 
									class=colorblur onfocus="this.className='colorfocus';" 
									maxLength=50 type=text id=textareademo name=demo.textareademo cols="40" rows="3">${demo.textareademo }</textarea>
								<SPAN  id=ctl03>*</SPAN>
							</TD>
						</TR>

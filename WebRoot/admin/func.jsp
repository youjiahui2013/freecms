      ...
      <div id="one"><fs:operButton buttonName="添加一级菜单" />
		  ...
		  <input type="hidden" name="parid" value="" id="parid">
     		 ...
     		 <tr>
          		...
          		<td height="25" align="left" valign="middle" bgcolor="#FFFFFF" style="padding-left:7px">
          		<input type="text" id="menuName" name="menuName" MAXLENGTH="50" class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';">
          		</td>
          		<td height="25" align="left" valign="middle" bgcolor="#FFFFFF" style="padding-left:7px">
          		菜单地址:
          		</td>
          		<td height="25" align="left" valign="middle" bgcolor="#FFFFFF" style="padding-left:7px">
          		<input type="text" id="menuUrl" MAXLENGTH="500" class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';">
          		</td>
          		</tr>
          		<tr>
          		<td height="25" align="left" valign="middle" bgcolor="#FFFFFF" style="padding-left:7px">

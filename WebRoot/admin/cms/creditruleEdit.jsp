					...
					<TBODY>
						...
						<TR>
							...
							<TD align="left">
								...
								<input type="radio" id="rewardtype0" name="creditrule.rewardtype" value="0" <s:if test='%{creditrule.rewardtype == 0}'>checked="checked"</s:if>>惩罚
							</TD>
						</TR>
						...
						<TR>
							...
							<select name="creditrule.cycletype" id="cycletype" onchange="cycletypeChange(this)">
								<option value="<%=Creditrule.CYCLETYPE_ONCE %>" ${0 == creditrule.cycletype?"selected":"" }>一次性</option>
								<option value="<%=Creditrule.CYCLETYPE_EVERYDAY %>" ${1 == creditrule.cycletype?"selected":"" }>每天一次</option>
								<option value="<%=Creditrule.CYCLETYPE_INTERVAL %>" ${2 == creditrule.cycletype?"selected":"" }>按间隔时间</option>
								<option value="<%=Creditrule.CYCLETYPE_UNLIMIT %>" ${4 == creditrule.cycletype?"selected":"" }>不限制</option>
							</select>
							</TD>
						</TR>

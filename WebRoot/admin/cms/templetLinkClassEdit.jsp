				...
				<TABLE cellSpacing=4 cellPadding=4 width="95%" align=center>
					<TBODY>
						...
						<TR>
							...
							<TD align="left">
          		<input type="text" id="ordernum" value="${templetLink.ordernum }" name="templetLink.ordernum" onkeyup=if(!isInt(value))execCommand('undo') onafterpaste=if(!isInt(value))execCommand('undo') class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';">
							</TD>
						</TR>
					</TBODY>
				</TABLE>

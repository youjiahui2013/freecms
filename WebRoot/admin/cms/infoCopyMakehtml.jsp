...
<HTML>
	...
	<BODY>
			...
			<DIV class="column">
				...
				<form action="info_copyMakehtml.do">
			...
			<input type="hidden" name="channel.id" value="${channel.id }"/>
				...
				<input type="button" value="不，我要继续复制信息" onclick="location.href='info_list.do?pageFuncId=${pageFuncId }&info.channel=${oldchannelid }'"  class="button"  />

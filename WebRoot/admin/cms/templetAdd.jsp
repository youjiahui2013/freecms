				...
				<TABLE cellSpacing=4 cellPadding=4 width="95%" align=center>
					<TBODY>
						...
						<TR>
							...
							<TD align="left">
          		<input type="text" id="ordernum" value="" name="templet.ordernum" onkeyup=if(!isInt(value))execCommand('undo') onafterpaste=if(!isInt(value))execCommand('undo') class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';">
							</TD>
						</TR>
						<TR>
							<TD width="30%" align="left">
							...
							<TD align="left">
								<textarea onblur="this.className='colorblur';"  title="点击选择站点" style="cursor:hand"
									...
									maxLength=50 type=text id=sitenames name=templet.usesitenames cols="40" rows="3"></textarea>

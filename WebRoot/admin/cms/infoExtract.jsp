...
<HTML>
	...
	<script src="../../js/jquery.treeview.async.js" type="text/javascript"></script>
		...
		<script type="text/javascript" src="js/infoExtract.js"></script>
	</HEAD>
	<BODY style="padding:0;margin:0">
		<form name="myForm" method="post" action="info_extract.do" id="myForm"
			style="margin: 0px">
					...
					<TBODY>
						<TR class=summary-title>
							<TD height="30" align=left style="padding-left: 10px;">
								...
								<input name="channelname" id="channelname" type="text" maxlength="500" readonly onclick="selectChannel()"
								...
								<input name="info.searchKey" type="text" maxlength="500" value="${info.searchKey }"
				...
				<table id="MyDataList" cellspacing="1" cellpadding="1"
					...
					<TR class="tdbg" onMouseOver="this.className='tdbg-dark';"  id="tr<s:property value="id"/>"
						...
						<TD  align="left" id="title<s:property value="id"/>">
							<a title="点击打开信息页面" href='<%=basePath %>info_visit.do?info.id=<s:property value="id"/>' target="_blank"><s:property value="title"/></a>
						</TD>

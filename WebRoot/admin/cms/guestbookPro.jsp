				...
				<TABLE cellSpacing=4 cellPadding=4 width="95%" align=center>
					<TBODY>
						...
						<TR>
							...
							<TD  align="left" colspan="3">
							<input type="radio" name="guestbook.state" value="0" ${guestbook.state!="1" && guestbook.state!="2" ?"checked":"" }>未审核
							...
							<TD  align="left" colspan="3">
								...
								<textarea onblur="this.className='colorblur';"  
									class=colorblur onfocus="this.className='colorfocus';" 
									 type=text id=recontent name=guestbook.recontent style="width:100%;height:100px">${guestbook.recontent }</textarea>
							</TD>
						</TR>

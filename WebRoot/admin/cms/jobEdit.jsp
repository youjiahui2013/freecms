				...
				<TABLE cellSpacing=4 cellPadding=4 width="95%" align=center>
					<TBODY>
						...
						<TR>
							...
							<TD width="70%" align="left">
								<INPUT onblur="this.className='inputblur';" id=num  onkeyup=if(!isInt(value))execCommand('undo') onafterpaste=if(!isInt(value))execCommand('undo')
									class=inputblur onfocus="this.className='inputfocus';" 
						...
						<TR>
							...
							<TD width="70%" align="left">
								<textarea onblur="this.className='inputblur';"  
									class=inputblur onfocus="this.className='inputfocus';" 
									maxLength=50 type=text id=jobrequire name=job.jobrequire cols="40" rows="3">${job.jobrequire }</textarea>
							</TD>
						</TR>
						<TR>
							<TD width="30%" align="left">
							...
							<TD width="70%" align="left">
							<input name="job.addtime" id="addtime"  class="Wdate"  type="text" size="18" value="${job.addtimeStr }"  onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})"/>
						...
						<TR>
							...
							<TD width="70%" align="left">
							<input name="job.endtime" id="endtime"  class="Wdate"  type="text" size="18" value="${job.endtimeStr }"  onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})"/>

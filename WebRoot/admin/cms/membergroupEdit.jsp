					...
					<TBODY>
						...
						<TR>
							...
							<TD width="70%" align="left">
								<INPUT  id=color
									class="color"
									maxLength=50 type=text name=membergroup.color value="${membergroup.color }<s:if test="membergroup==null || membergroup.color == null || membergroup.color ==''">000000</s:if>">
							</TD>
						</TR>
						<TR id="beginexperienceTr">
							<TD width="30%" align="left">
						...
						<TR>
							...
							<TD width="70%" align="left">
								<input type="radio" id="commentneedcheck1"  name="membergroup.commentneedcheck" value="1" <s:if test="membergroup==null || membergroup.commentneedcheck==null || membergroup.commentneedcheck==1">checked="checked"</s:if>>是
								<input type="radio" id="commentneedcheck0"  name="membergroup.commentneedcheck" value="0" <s:if test="membergroup.commentneedcheck==0">checked="checked"</s:if> >否
								<SPAN  id=ctl03>*</SPAN>
							</TD>
						</TR>
						<TR>

				...
				<TABLE cellSpacing=4 cellPadding=4 width="95%" align=center>
					<TBODY>
						...
						<TR>
							...
							<TD align="left">
								<input type="radio" id="isok1" name="templetChannel.state" value="1" <s:if test="channel==null || templetChannel.state==null || templetChannel.state==1">checked="checked"</s:if>>是
								<input type="radio" id="isok0" name="templetChannel.state" value="0" <s:if test="templetChannel.state==0">checked="checked"</s:if> >否
							</TD>
						</TR>
						<TR>
							<TD width="30%" align="left">
							...
							<TD align="left">
								<input type="radio" id="isok1" name="templetChannel.navigation" value="1" <s:if test="channel==null || templetChannel.navigation==null || templetChannel.navigation==1">checked="checked"</s:if>>是
								<input type="radio" id="isok0" name="templetChannel.navigation" value="0" <s:if test="templetChannel.navigation==0">checked="checked"</s:if> >否
							</TD>
						</TR>
						<TR>
							<TD width="30%" align="left">
						...
						<TR>
							...
							<TD width="70%" align="left">
								<INPUT onblur="this.className='colorblur';" id=templet readonly style="cursor:hand" title="点击选择模板文件"
									class=colorblur onfocus="this.className='colorfocus';" onclick="selectTempletFile('${templet.id }','templet')"
						...
						<TR>
							...
							<TD width="70%" align="left">
								<INPUT onblur="this.className='colorblur';" id=contenttemplet  readonly style="cursor:hand" title="点击选择模板文件"
									class=colorblur onfocus="this.className='colorfocus';" onclick="selectTempletFile('${templet.id }','contenttemplet')"
						...
						<TR>
							...
							<span id="oldImgSpan">
							<a href="<%=basePath %>templet/${templet.id }${templetChannel.img }?date=<%=UUID.randomUUID() %>" target="_blank">
							<img src="<%=basePath %>templet/${templet.id }${templetChannel.img }?date=<%=UUID.randomUUID() %>" width="180" height="42" title="点击查看大图"/>
							</a>
							...
							<TD align="left"> 
				<input type="checkbox" name="templetChannel.htmlchannel" value="1" ${"1" == templetChannel.htmlchannel ?" checked ":"" }/>静态化所属栏目页面<br/>
				<input type="checkbox" name="templetChannel.htmlchannelold" value="1" ${"1" == templetChannel.htmlchannelold ?" checked ":"" }/>静态化原所属栏目页面<br/>
				<input type="checkbox" name="templetChannel.htmlparchannel" value="1"  ${"1" == templetChannel.htmlparchannel ?" checked ":"" }/>静态化所属栏目的所有父栏目页面<br/>
				<input type="checkbox" name="templetChannel.htmlsite" value="1"  ${"1" == templetChannel.htmlsite ?" checked ":"" }/>静态化站点首页<br/>
							</TD>
						</TR>
						...
						<TR>
							<TD width="70%" align="left"  colspan="10" id="dsecTd" style="display:none">
								...
								<textarea onblur="this.className='colorblur';"  
									class=colorblur onfocus="this.className='colorfocus';" 
									 name=templetChannel.description style="width:100%;height:100px">${templetChannel.description }</textarea>

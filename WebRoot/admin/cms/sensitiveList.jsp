...
<HTML>
	...
	<BODY style="padding:0;margin:0">
		...
		<form name="myForm" method="post" action="sensitive_list.do?pageFuncId=${param.pageFuncId }" id="myForm"
			style="margin: 0px">
					...
					<TBODY>
						<TR class=summary-title>
							<TD height="30" align=left style="padding-left: 10px;">
								敏感词:
								<input name="sensitive.sensitiveword" type="text" maxlength="500"
									class="colorblur" onfocus="this.className='colorfocus';"
									onblur="this.className='colorblur';"  />
							替换为:
								
								<input name="sensitive.replaceto" type="text" maxlength="500"
									class="colorblur" onfocus="this.className='colorfocus';"
									onblur="this.className='colorblur';"  />
			...
			<DIV class="column" style="width:99%">
				...
				<table id="MyDataList" cellspacing="1" cellpadding="1"
					...
					<s:iterator value="sensitiveList" id="bean">
					<TR class="tdbg" onMouseOver="this.className='tdbg-dark';"  id="tr<s:property value="id"/>"
						...
						<TD  align="left" id="sensitiveword<s:property value="id"/>">
							<s:property value="sensitiveword"/>
						</TD>
						<TD  align="left" id="replaceto<s:property value="id"/>">
							<s:property value="replaceto"/>
						</TD>
					</TR>
					</s:iterator>
					<TR class="tdbg" 

				...
				<TABLE cellSpacing=4 cellPadding=4 width="99%" align=center>
					<TBODY>
						...
						<TR>
							...
							<TD align="left">
								<input type="radio" name="question.selecttype" value="0" <s:if test="question==null || question.selecttype==0">checked="checked"</s:if>>单选
								<input type="radio" id="selecttype1" name="question.selecttype" value="1" <s:if test="question.selecttype==1">checked="checked"</s:if> >多选
							</TD>
						</TR>
						...
						<TR>
							...
							<TD align="left">
								<input type="radio" name="question.isok" value="1" <s:if test="question==null || question.isok==1">checked="checked"</s:if>>是
								<input type="radio" id="isok0" name="question.isok" value="0" <s:if test="question.isok==0">checked="checked"</s:if> >否
							</TD>
						</TR>

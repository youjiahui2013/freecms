...
<div id="man_zone" >
  ...
  <b> 顺序</b>
   ...
   <tr>
    ...
    <input type="text"  id="name" name="name" size="30" MAXLENGTH="50" class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';">
      </td>
      <td >
    ...
    <input type="text" value="<%=answer.getName() %>" size="30" id="name<%=answer.getId() %>" name="name<%=answer.getId() %>" MAXLENGTH="50" class="colorblur" onfocus="this.className='colorfocus';" onblur="this.className='colorblur';">
      </td>
      <td >

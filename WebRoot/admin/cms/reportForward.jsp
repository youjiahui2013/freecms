						...
						<TR>
							...
							<TD  align="left">
								<LABEL id=ctl01_ctl00_label>
										...
										<input type="hidden" name="report.username" id="username" value="${bean.name }"/>
												</s:if>
										</s:iterator>
										<select id="userid" name="report.userid" onchange="$('#username').val(this.options[this.selectedIndex].text);" >

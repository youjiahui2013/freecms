...
<form id="form1" action="html_infoDo.do" method="post">
  <table width="99%" border="0" align="left"  cellpadding="3" cellspacing="1" >
	...
	<ul id="mixedchannel" >
		<s:iterator value="channelList" var="bean" status="stuts">
			<li id="<s:property value="id"/>" class="hasChildren">
				...
				<input type="checkbox" name="channels" value="<s:property value="id"/>"><b><s:property value="name"/></b>
				</s:if>
				<s:if test='%{!#session.siteAdmin && "1"!=#bean.haveChannelRole}'>
    ...
    <tr>
    <td align="left" valign="top" >
		开始时间:<input name="info.starttime" id="starttime"  class="Wdate"  type="text" size="24" value=""  onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
						
    </td>
    </tr>
    <tr>
    <td align="left" valign="top" >
		结束时间:<input name="info.endtime" id="endtime"  class="Wdate"  type="text" size="24" value=""  onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>

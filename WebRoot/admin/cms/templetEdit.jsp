				...
				<TABLE cellSpacing=4 cellPadding=4 width="95%" align=center>
					<TBODY>
						...
						<TR>
							...
							<TD align="left">
								<input type="radio" name="templet.state" value="1" <s:if test="templet==null || templet.state==1">checked="checked"</s:if>>是
								<input type="radio" id="isok0" name="templet.state" value="0" <s:if test="templet.state==0">checked="checked"</s:if> >否
							</TD>
						</TR>
						<TR>
							<TD  align="left">
						...
						<TR>
							...
							<TD align="left">
								<textarea onblur="this.className='colorblur';"  title="点击选择站点" style="cursor:hand"
									class=colorblur onfocus="this.className='colorfocus';" readonly="readonly" onclick="siteSelect()"
									maxLength=50 type=text id=sitenames name=templet.usesitenames cols="40" rows="3">${templet.usesitenames }</textarea>

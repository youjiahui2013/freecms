			...
			<div class="columntitle">
				...
				<table id="MyDataList" cellspacing="1" cellpadding="1"
					...
					<TR class="tdbg" onMouseOver="this.className='tdbg-dark';"  id="tr<s:property value="id"/>"
						...
						<TD align="center">
							<INPUT name="ids" type="checkbox" value="<s:property value="id"/>" id="type1group<s:property value="id"/>"/></TD>
			...
			<DIV class=column100>
				...
				<table id="MyDataList" cellspacing="1" cellpadding="1"
					...
					<TR class="tdbg" onMouseOver="this.className='tdbg-dark';"  id="tr<s:property value="id"/>"
						style="HEIGHT: 25px" onMouseOut="this.className='tdbg';">
						<TD align="center">
							<INPUT name="ids" type="checkbox" value="<s:property value="id"/>" id="type2group<s:property value="id"/>"/></TD>
			...
			<DIV class=column100>
				...
				<table id="MyDataList" cellspacing="1" cellpadding="1"
					...
					<TR class="tdbg" onMouseOver="this.className='tdbg-dark';"  id="tr<s:property value="id"/>"
						style="HEIGHT: 25px" onMouseOut="this.className='tdbg';">
						<TD align="center">
							<INPUT name="ids" type="checkbox" value="<s:property value="id"/>" id="type3group<s:property value="id"/>"/></TD>

	...
	<ul id="mixed" >
			<s:iterator value="channelList" var="bean" status="stuts">
				<li id="<s:property value="id"/>" class="hasChildren">
					...
					<b><a href="#" onclick="showOne('<s:property value="id"/>','<s:property value="name"/>')"><s:property value="name"/></a></b>
					</s:if>
					<s:if test='%{!#session.siteAdmin && "1"!=#bean.haveChannelRole}'>
      ...
      <iframe width="100%" height="500" id="infoFrame" framespacing="0" border="false"  frameborder="0"></iframe>

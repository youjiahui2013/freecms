  ...
  <table width="99%" border="0" align="left"  cellpadding="3" cellspacing="1" >
    <tr>
      <td width="30%"  align="left" valign="top" class="treetd">
			...
			<br/><input type="button" class="button" value="添加一级站点" onclick="document.getElementById('siteFrame').src='site_edit.do'">
			</input>
			</s:if>
		...
		<s:if test="%{#session.loginAdmin.loginname == 'admin'}">
			<s:iterator value="siteList" status="bean">
				<li id="<s:property value="id"/>" class="hasChildren">
					<span><font size="2">
					<a href="site_edit.do?site.id=<s:property value="id"/>" target="siteFrame"><b><s:property value="name"/></b></a></font>
					</span>
					<ul>
						<li><span  >&nbsp;</span></li>
					</ul>

...
<html>
  ...
  <table width="99%" border="0" align="left"  cellpadding="3" cellspacing="1" >
	...
	<ul id="mixedpar" >
		...
		<s:if test="%{#session.loginAdmin.loginname == 'admin'}">
			<s:iterator value="siteList" status="bean">
				<li id="<s:property value="id"/>" class="hasChildren">
					<span><font size="2">
					<a href="cms/site_authPage.do?site.id=<s:property value="id"/>&role.id=${role.id }" target="siteFrame"><b><s:property value="name"/></b></a></font>${haveSiteRole}
					</span>
					<ul>
						<li><span  >&nbsp;</span></li>
					</ul>
      ...
      <iframe width="100%" height="380" name="siteFrame" id="siteFrame" framespacing="0" border="false"  frameborder="0"></iframe>

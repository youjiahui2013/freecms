					...
					<TR>
							...
							<TD align="left">
								<textarea onblur="this.className='colorblur';"  title="点击选择所属部门" style="cursor:hand"
									...
									maxLength=50 type=text id=unitname name=user.unitNames cols="40" rows="3">${user.unitNames }</textarea>
						...
						<TR>
							...
							<TD align="left">
								...
								<input type="radio" id="usersex0" name="user.sex" value="0" <s:if test='%{user.sex == "0"}'>checked="checked"</s:if>>女
							</TD>
						</TR>
						<TR>
							<TD width="30%" align="left">
							...
							<TD align="left">
		  <input name="user.birthday" id="birthday" value="${user.birthdayStr }" class="Wdate"  type="text" size="14" value=""  onClick="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d'})"/>
							</TD>
						</TR>
						<TR>
							<TD width="30%" align="left">
						...
						<TR>
							...
							<TD align="left">
								<input type="radio" id="mail1" name="user.ismail" value="1" <s:if test='%{user.ismail == "1"}'>checked="checked"</s:if>>是
								<input type="radio" id="mail0" name="user.ismail" value="0" <s:if test='%{user.ismail != "1"}'>checked="checked"</s:if>>否
							</TD>
						</TR>
					</TBODY>
				</TABLE>
